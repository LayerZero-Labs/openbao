...
- `type` `(string: "aes256-gcm96")` – Specifies the type of key to create. The
  ...
  - `ecdsa-secp256k1` – ECDSA using the secp256k1 (Koblitz) elliptic curve
    (asymmetric). Signs a caller-supplied 32-byte digest verbatim; see the
    secp256k1 notes in the Transit documentation.
